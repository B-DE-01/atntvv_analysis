...
```{r}
at_s1_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s1_nc_wgcna.csv', sep = ',')
at_s2_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s2_nc_wgcna.csv', sep = ',')
at_s3_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s3_nc_wgcna.csv', sep = ',')

nt_s1_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s1_nc_wgcna.csv', sep = ',')
nt_s2_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s2_nc_wgcna.csv', sep = ',')
nt_s3_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s3_nc_wgcna.csv', sep = ',')


vv_p1_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/vv_p1_nc_wgcna.csv', sep = ',')
vv_p2_tpm <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/vv_p2_nc_wgcna.csv', sep = ',')
...
```{r}
core_orth <- read.delim('/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/core_best_reps.tsv', sep = '\t')
