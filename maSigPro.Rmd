...
```{r}
edesignat <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Collinear/MaSigPro/at_nt_timepoint_design.txt")
...
```{r}
core_reps <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/at_nt_bestreps.tsv", sep = "\t")

core_reps$nt <- sub(".*\\|", "", core_reps$nt)
core_reps$at <- sub(".*\\|", "", core_reps$at)

at_s1 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s1_nc_wgcna.csv", sep = ",")
at_s2 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s2_nc_wgcna.csv", sep = ",")
at_s3 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/at_s3_nc_wgcna.csv", sep = ",")

nt_s1 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s1_nc_wgcna.csv", sep = ",")
nt_s2 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s2_nc_wgcna.csv", sep = ",")
nt_s3 <- read.delim("/Users/ben/Desktop/Research/Robatzek/Paper R Notebooks/Non-Collinear/WGCNA/nt_s3_nc_wgcna.csv", sep = ",")
...
```{r}
# plot Venn diagram for specific groups
get_groups <- get.siggenes(Ntt, rsq = 0.6, vars="groups")
get_groups$summary
suma2Venn(get_groups$summary)
```
